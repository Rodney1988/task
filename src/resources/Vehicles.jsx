...
export const Vehicles = () => {
  ...
  if (isError) {
    return <Alert severity="error">Error fetching Vehicles Data</Alert>;
  }
    ...
    <AuthorizationWrapper>
      <StyledDivWrapper>
        ...
        <Paper>
          ...
          <Typography variant="h7">{data.count} vehicles in total</Typography>
          <SearchBar
